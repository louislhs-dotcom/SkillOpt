"""Data loader for the hermes-prompt env.

CRITICAL: must NOT drop check / must_not / optional / order fields — the
scorer reads them directly off each item dict.
"""
...
def _normalize_item(raw: dict) -> dict:
    return {
        ...
        "task_type": str(raw.get("task_type") or "hermes-prompt"),
...
class HermesPromptDataLoader(SplitDataLoader):
